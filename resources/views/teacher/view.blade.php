    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-3">
          ...
          <input type="text" id="viewName" class="form-control" value="{{ $teacher->name }}" readonly>
        </div>
        <div class="mb-3">
          <label class="form-label">Phone:</label>
          <input type="text" id="viewPhone" class="form-control" value="{{ $teacher->phone }}" readonly>
        </div>
          <div class="mb-3">
          <label class="form-label">CNIC:</label>
          <input type="text" id="viewCNIC" class="form-control" value="{{ $teacher->cnic }}" readonly>
        </div>
        <div class="mb-3">
          <label class="form-label">Department:</label>
          <input type="text" id="viewDepartment" class="form-control" value="{{ $teacher->department }}" readonly>
        </div>
        <div class="mb-3">
          <label class="form-label">D.O.B:</label>
          <input type="text" id="viewDateOfBirth" class="form-control" value="{{ $teacher->date_of_birth }}" readonly>
        </div>
        <div class="mb-3">
          <label class="form-label">Address:</label>
          <input id="viewAddress" class="form-control" value="{{ $teacher->address }}" readonly>
        </div>
        <div class="mb-3">
          <label class="form-label">Gender:</label>
          <input id="viewGender" class="form-control" value="{{ $teacher->gender }}" readonly>
        </div>
      </div>
